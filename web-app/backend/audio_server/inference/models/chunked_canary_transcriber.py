...
from inference.models.canary_transcriber import CanaryTranscriber
from inference.models.force_aligner import ForceAligner

from pydub import AudioSegment

class ChunkedCanaryTranscriber:
	def __init__(self):
		self.transcriber = CanaryTranscriber(model_name='nvidia/canary-1b')
